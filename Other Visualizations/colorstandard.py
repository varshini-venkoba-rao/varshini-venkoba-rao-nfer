...
if RGB_REF_AVAILABLE == 1:
    ...
    print(color_error_obj.delta_E)
    print(type(color_error_obj.delta_E))
color= pd.DataFrame(color_error_obj.delta_E.items(),columns=["Type","Error"])     
color.to_csv('/home/nference/Desktop/varsh.csv',index=False)    
